...
interface UserResponseContextType {
  ...
  updateResponse: (
    key: keyof UserResponses,
    value: string | boolean | null,
  ) => void;
}

const UserResponseContext = createContext<UserResponseContextType | undefined>(
  undefined,
);
...
export const useUserResponse = () => {
  ...
  if (!context) {
    throw new Error(
      "useUserResponse must be used within a UserResponseProvider",
    );
  }
  return context;
};
